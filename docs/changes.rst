...
- key change-algorithm: to upgrade existing repos to argon2 or downgrade to pbkdf2.
  We recommend you to upgrade unless you have to keep the repo compatible with older versions of borg.
