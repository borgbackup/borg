...
``keys`` subdirectory
  In this directory all your repository keyfiles are stored. This does **not** apply if you
  use the repokey mode because your key is stored alongside the the repository. You MUST make sure to have an
