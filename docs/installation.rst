...
- Segment files generated by |project_name| have low default file size
  requirements. By default, segment files are 500MiB. This can be modified in
  the :ref:`config-file`.
...
- |project_name| uses Mkdir based file locking.
...
- |project_name| uses the following file system operations:
  ...
  - link (hardlink) - when upgrading an Attic repo in-place
  - listdir, stat
