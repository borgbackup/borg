...
On a dedicated borg backup server, it is recommended to set the
backup user's shell to a simple implementation::
...
associated with a feature-rich complex code base.
