...
class Archiver:
    ...
    def build_parser(self):
        ...
        **one can end up with truncated output being backed up**. Using
        ...
        In this mode upgrading to `argon2` will make it imbossible to access the repo for users that use an old version of borg.
        ...
        In this mode this command will only change the key used by the current user. Other users will still be able to access the repo.
        If you want to upgrade to `argon2` to strengthen security, you will have to upgrate each user individually.
