...
from ..cache import get_archive_references, list_archive_reference_caches, cleanup_archive_reference_caches
...
class ArchiveGarbageCollector:
    ...
    def analyze_archives(self) -> tuple[set, int, int, int]:
        ...
        if not self.dry_run:
            ...
            cleanup_archive_reference_caches(self.repository, cached_hex_ids - valid_hex_ids)
