...
class Location:
    ...
    file_re = re.compile(
        ...
        + optional_archive_re,
        re.VERBOSE,
    )  # servername/path, path or path::archive
    ...
    env_re = re.compile(
        r"""                                # the repo part is fetched from BORG_REPO
        (?:::$)                                             # just "::" is ok (when a pos. arg is required, no archive)
        |                                                   # or
        """
        + optional_archive_re,
        re.VERBOSE,
    )  # archive name (optional, may be empty)
...
class ItemFormatter(BaseFormatter):
    ...
    KEYS_REQUIRING_CACHE = ("dsize", "dcsize", "unique_chunks")
