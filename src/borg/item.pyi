...
class Item(PropDict):
    ...
    @property
    def digests(self) -> StableDict: ...
    @digests.setter
    def digests(self, val: StableDict) -> None: ...
    @property
    ...
    # legacy borg1 on-disk key, only read when transferring borg1 archives
    @property
    ...
    @size.setter
    def size(self, val: int) -> None: ...
    def get_size(self, *, memorize: bool = ..., from_chunks: bool = ..., consider_ids: list[bytes] = ...) -> int: ...
    @property
    def part(self) -> int: ...
    @part.setter
...
class EncryptedKey(PropDict):
    ...
    @property
    def fido2_credential_id(self) -> bytes: ...
    @fido2_credential_id.setter
    def fido2_credential_id(self, val: bytes) -> None: ...
    @property
    def fido2_up_required(self) -> bool: ...
    @fido2_up_required.setter
    def fido2_up_required(self, val: bool) -> None: ...
    @property
    def fido2_uv_required(self) -> bool: ...
    @fido2_uv_required.setter
    def fido2_uv_required(self, val: bool) -> None: ...
